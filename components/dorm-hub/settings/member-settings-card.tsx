...
export function MemberSettingsCard(props: {
  t: any;
  me: any;
  folded: boolean;
  title: string;
  ...
  return (
    <SettingsCard title={title} folded={folded} onToggle={onToggle} toggleLabel={toggleLabel} className={`glass-card sleep-depth-mid rounded-3xl ${folded ? 'px-7 py-4 md:px-8 md:py-4' : 'p-7 md:p-8'}`}>
