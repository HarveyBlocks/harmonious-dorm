...
export function SecuritySettingsCard(props: {
  t: any;
  folded: boolean;
  toggleLabel: string;
  onToggle: () => void;
  ...
  return (
    <SettingsCard title={t.accountSecurity} folded={folded} onToggle={onToggle} toggleLabel={toggleLabel} className={`glass-card sleep-depth-mid rounded-3xl ${folded ? 'px-7 py-4 md:px-8 md:py-4' : 'p-7 md:p-8'}`}>
