...
function buildWalletProps(p: any) {
  return {
    ...
    deleteBillMutation: p.deleteBillMutation,
...
function buildBotSettingsProps(p: any) {
  return {
    ...
    botToolPermissionLabel: p.botToolPermissionLabel, toolPermissionAllowLabel: p.toolPermissionAllowLabel, toolPermissionDenyLabel: p.toolPermissionDenyLabel,
    noFieldsYetText: p.noFieldsYet, botSettingsInput: p.botSettingsInput, setBotSettingsInput: p.setBotSettingsInput,
    botToolPermissionsInput: p.botToolPermissionsInput, setBotToolPermissionsInput: p.setBotToolPermissionsInput,
